...
export const addImporterDetails = (payload) => async (dispatch) => {
  dispatch({
    type: actionTypes.ADD_IMPORTER,
    payload: payload,
  });
};

export const addExporterDetails = (payload) => ({
  type: actionTypes.ADD_EXPORTER,
  payload,
});
